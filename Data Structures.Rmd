...
This is a cheat sheet for R, and contains lots of exerpts from [Advanced R](http://adv-r.had.co.nz/Data-structures.html).  Read this if you've been away from R for awhile and need a quick refresher.

## R Markdown

This works a lot like regular markdown, but can include code that can be run or included in reports. Code sections can include parameters, and these are some important ones:

- echo:  include source code in report
- eval:  run the code
- include:  include output (like plots) in report
