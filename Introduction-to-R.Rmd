...
R is a programming language commonly used for data analytics.  [RStudio](https://rstudio.com/) is a company which makes an IDE (also called RStudio) commonly used with the R language.  There are three versions of the IDE:  a desktop program, a cloud-based version, and a "pro" cloud-based version.  They all work similarly.  If you open the RStudio IDE (with the default layout), you'll see several windows arranged as follows:
...
* Lower Left
  * **Console**:  R interpreter with command line
    * Working directory displayed at top.
* Upper Right
...
A weird shortcut:  Ctrl+Z = undo. Ctrl+Shift+Z = redo.
